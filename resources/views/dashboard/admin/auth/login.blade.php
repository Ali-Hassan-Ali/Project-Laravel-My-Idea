...
<body>
    ...
    <section class="login-content">
        ...
        <div class="login-box">
            ...
            <form class="login-form" method="post" action="{{ route('dashboard.admin.login') }}">
                <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN</h3>
                    ...
                    <div class="form-group">
                        <label class="control-label">@lang('admins.email')</label>
                    ...
                    {{-- password --}}
                    <div class="form-group">
                        <label class="control-label">@lang('admins.password')</label>
